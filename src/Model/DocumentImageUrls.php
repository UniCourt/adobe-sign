...
class DocumentImageUrls implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'imageURLs' => '\Adobe\ESign\Model\PageImageUrl[]',
    ...
    protected static $setters = [
        ...
        'imagesAvailable' => 'setImagesAvailable',
    ...
    protected static $getters = [
        ...
        'imagesAvailable' => 'getImagesAvailable',
    ...
    {
        $this->container['imageURLs'] = isset($data['imageURLs']) ? $data['imageURLs'] : null;
        $this->container['imagesAvailable'] = isset($data['imagesAvailable']) ? $data['imagesAvailable'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['imageSize']) && !in_array($this->container['imageSize'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'imageSize', must be one of '%s'",
     ...
     * Sets imageURLs
     *
     * @param \Adobe\ESign\Model\PageImageUrl[] $imageURLs A list of image url (one per page).
     *
     * @return $this
     */
    ...
    /**
     * Gets imagesAvailable
     *
     * @return bool
     */
    public function getImagesAvailable()
    {
        return $this->container['imagesAvailable'];
    }

    /**
     * Sets imagesAvailable
     *
     * @param bool $imagesAvailable true if images for the associated image size is available, else false.
     *
     * @return $this
     */
    public function setImagesAvailable($imagesAvailable)
    {
        $this->container['imagesAvailable'] = $imagesAvailable;
     ...
     * Sets imageSize
     *
     * @param string $imageSize ImageSize corresponding to the imageUrl returned
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getImageSizeAllowableValues();
        if (!is_null($imageSize) && !in_array($imageSize, $allowedValues, true)) {
