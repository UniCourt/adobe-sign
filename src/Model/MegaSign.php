...
class MegaSign implements ModelInterface, ArrayAccess
{
     ...
     * Sets displayDate
     *
     * @param \DateTime $displayDate The display date for the MegaSign parent agreement. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
     *
     * @return $this
     */
