...
class DetailedParticipantSetInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'memberInfos' => '\Adobe\ESign\Model\DetailedParticipantInfo[]',
        'order' => 'int',
        'status' => 'string'
    ];
     ...
     * Sets memberInfos
     *
     * @param \Adobe\ESign\Model\DetailedParticipantInfo[] $memberInfos Array of ParticipantInfo objects, containing participant-specific data (e.g. email). All participants in the array belong to the same set
     *
     * @return $this
     */
