...
class SendViewConfiguration implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['agrName'] = isset($data['agrName']) ? $data['agrName'] : null;
    }
    ...
    {
        return $this->container['agrName'];
    }

    /**
     * Sets agrName
     *
     * @param string $agrName The agreement name for the library document on the compose page
     *
     * @return $this
     */
    public function setAgrName($agrName)
    {
        $this->container['agrName'] = $agrName;
