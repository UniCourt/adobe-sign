...
class SupportingDocument implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['numPages'] = isset($data['numPages']) ? $data['numPages'] : null;
     ...
     * Sets displayLabel
     *
     * @param string $displayLabel Display name of the document
     *
     * @return $this
     */
     ...
     * Sets fieldName
     *
     * @param string $fieldName The name of the supporting document field
     *
     * @return $this
     */
