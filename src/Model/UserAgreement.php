...
class UserAgreement implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'esign' => 'bool',
        'name' => 'string',
        'displayParticipantSetInfos' => '\Adobe\ESign\Model\DisplayParticipantSetInfo[]',
     ...
     *
     * @param \Adobe\ESign\Model\DisplayParticipantSetInfo[] $displayParticipantSetInfos The most relevant current user set for the agreement. It is typically the next signer if the agreement is from the current user, or the sender if received from another user
     *
     * @return $this
     */
