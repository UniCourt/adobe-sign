...
class LibraryDocumentEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'deviceLocation' => '\Adobe\ESign\Model\LibDocEventDeviceLocation'
    ];
     ...
     * Sets deviceLocation
     *
     * @param \Adobe\ESign\Model\LibDocEventDeviceLocation $deviceLocation Location of the device that generated the event (This value may be null due to limited privileges)
     *
     * @return $this
     */
