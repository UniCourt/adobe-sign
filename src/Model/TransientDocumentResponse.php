...
class TransientDocumentResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $transientDocumentId The unique identifier of the uploaded document that can be used in an agreement or a megaSign or widget creation call
     *
     * @return $this
     */
