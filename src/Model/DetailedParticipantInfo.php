...
class DetailedParticipantInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'email' => 'string',
        'securityOption' => '\Adobe\ESign\Model\ParticipantSecurityOption',
        'status' => 'string'
    ];
     ...
     * Sets privateMessage
     *
     * @param string $privateMessage The private message of the participant, if available. This cannot be changed as part of the PUT call.
     *
     * @return $this
     */
     ...
     * Sets securityOption
     *
     * @param \Adobe\ESign\Model\ParticipantSecurityOption $securityOption Security options that apply to the participant. This cannot be changed as part of the PUT call
     *
     * @return $this
     */
