...
class URLFileInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets mimeType
     *
     * @param string $mimeType The mime type of the referenced file, used to determine if the file can be accepted and the necessary conversion steps can be performed
     *
     * @return $this
     */
