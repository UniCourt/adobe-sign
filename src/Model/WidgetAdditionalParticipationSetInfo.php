...
class WidgetAdditionalParticipationSetInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets memberInfos
     *
     * @param \Adobe\ESign\Model\ParticipantSetMemberInfo[] $memberInfos Array of ParticipantInfo objects, containing participant-specific data (email, e.g.) for all the additional participants in the widget
     *
     * @return $this
     */
