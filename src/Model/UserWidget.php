...
class UserWidget implements ModelInterface, ArrayAccess
{
     ...
     * Sets modifiedDate
     *
     * @param \DateTime $modifiedDate The date on which the widget was last modified. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
     *
     * @return $this
     */
