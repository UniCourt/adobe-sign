...
class AgreementInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets email_option
     *
     * @param \Swagger\Client\Model\EmailOption $email_option Email configurations for the agreement. Should not be provided in offline agreement creation or when updating a non draft agreement.
     *
     * @return $this
     */
