...
class WidgetAdditionalParticipationSetInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets member_infos
     *
     * @param \Swagger\Client\Model\ParticipantSetMemberInfo[] $member_infos Array of ParticipantInfo objects, containing participant-specific data (email, e.g.) for all the additional participants in the widget
     *
     * @return $this
     */
