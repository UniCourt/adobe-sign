...
class LibraryViewInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'send_view_configuration' => '\Swagger\Client\Model\SendViewConfiguration'
    ];
     ...
     *
     * @return \Swagger\Client\Model\SendViewConfiguration
     */
     ...
     *
     * @param \Swagger\Client\Model\SendViewConfiguration $send_view_configuration Send page view configuration. This will be ignored for views other than SEND.
     *
     * @return $this
     */
